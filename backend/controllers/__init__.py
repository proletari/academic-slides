...
from .paper_controller import paper_bp

__all__ = ['project_bp', 'style_bp', 'page_bp', 'template_bp', 'user_template_bp', 'user_style_template_bp', 'export_bp', 'file_bp', 'material_bp', 'settings_bp', 'paper_bp']
