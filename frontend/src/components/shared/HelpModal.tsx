...
const i18nDict = {
  zh: {
    guide: {
      ...
      features: '功能介绍',
      featuresSub: '探索如何使用 AI 快速创建学术演示文稿',
      gallery: '结果案例',
      gallerySub: '以下是使用 Academic Slides 生成的演示文稿案例',
      galleryMore: '查看更多使用案例',
      hi: '欢迎使用 Academic Slides！',
      hiSub: '在开始前，让我们先完成基础配置',
      s1: '配置 API Key',
      s1d: '前往设置页面，配置项目需要使用的API服务，包括：',
      s1i: ['您的 AI 服务提供商的 API Base 和 API Key', '配置文本生成模型和图像生成模型', '若需要文件解析功能，请配置 MinerU Token', '若需要可编辑导出功能，请配置MinerU TOKEN 和 Baidu API KEY'],
      s2: '保存并测试',
